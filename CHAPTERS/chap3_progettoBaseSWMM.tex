...
\begin{figure}[p]
    ...
    \caption{progetto base  TANTE BELLE COSE}
...
\begin{table}[htbp]
    %\small
    \centering
    \caption{Intensità di precipitazione.}
    \label{tab:ietocost}
...
Ottenuti tutti i dati degli ietogrammi costanti si analizza il deflusso di ciascuno andando a constatare quale curva dia il picco maggiore e di conseguenza sapere quale sia il tempo critico del bacino. {\RED{(Figura Nicola deflusso del bacino)}}

Come si nota dalla figura {\RED{sopra/sotto}} il picco più gravoso e quindi l'evento meteorologico che influenza maggiormente l'area di studio si ha con una durata di pioggia di \SI{5}{\minute}.
...
\end{equation}
Facendo così la posizione del picco del deflusso risulterà a \SI{1}{\hour}.
{\RED{Fig. ietogramma Chicago}}
Discretizzando lo ietogramma Chicago ad intervalli di \SI{5}{\minute}, dalla figura {\RED{precedente}}, si osserva una prima fase di accumulo d'acqua, dove le depressioni superficiali iniziano a colmarsi, quindi prima del picco si ha che la zona è già stata in parte sollecitata.
...
\begin{landscape}
    \begin{figure}[htb]
        ...
        \begin{tikzpicture}
            ...
            \node at (axis cs:1.2,2600) [anchor=south west] {\SI{2610.67}{\litre\per\second}};
            \end{axis}
        \end{tikzpicture}
