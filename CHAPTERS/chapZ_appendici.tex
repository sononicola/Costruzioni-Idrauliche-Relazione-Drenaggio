...
\includepdf[pages={1},pagecommand={\thispagestyle{plain}\section{Computo metrico estimativo}\label{appendix:computo}},offset=0 -4cm]{img/computo1.pdf}
\includepdf[pages={1,2},pagecommand={\thispagestyle{plain}}]{img/computo2.pdf}
%\newgeometry{a3paper}
\includepdf[pages={1},pagecommand={\thispagestyle{plain}\section{Rappresentazione degli elementi della rete}\label{appendix:Tavola1}},fitpaper=true,scale=0.9,offset=0 -1cm]{img/tavole/tavola.pdf}