...
\begin{table}[p]
        ...
        \begin{tabular}{
                        ...
                        S[table-format=1.1]}
            \toprule
            \multicolumn{1}{c}{\multirow{2}{*}{Condotta}} & \multicolumn{1}{c}{\multirow{2}{*}{A valle di}}&\multicolumn{1}{c}{Deflusso}&\multicolumn{1}{c}{Deflusso totale}&\multicolumn{1}{c}{$i_F$}&\multicolumn{1}{c}{$D_{prog}$}&\multicolumn{1}{c}{$D_{comm}$}&\multicolumn{1}{c}{Offset}\\
